...
unrealRootPath=/mnt/Datos/UnrealEngine-4.27.2-release
DungeonCrawlerRootPath=/home/maty/Documents/UnrealProjects/DungeonCrawler

gameProjectFile=/home/maty/Documents/UnrealProjects/DungeonCrawler/DungeonCrawler.uproject
...
include(DungeonCrawlerSource.pri)
include(DungeonCrawlerHeader.pri)
include(DungeonCrawlerConfig.pri)
include(DungeonCrawlerIncludes.pri)
include(DungeonCrawlerDefines.pri)

DungeonCrawler-Linux-Debug.commands = $$build DungeonCrawler Linux Debug  -project="\"$$gameProjectFile\"" $$args
DungeonCrawler-Linux-DebugGame.commands = $$build DungeonCrawler Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DungeonCrawler-Linux-Shipping.commands = $$build DungeonCrawler Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DungeonCrawler-Linux-Test.commands = $$build DungeonCrawler Linux Test  -project="\"$$gameProjectFile\"" $$args
DungeonCrawler.commands = $$build DungeonCrawler Linux Development  -project="\"$$gameProjectFile\"" $$args

DungeonCrawlerEditor-Linux-Debug.commands = $$build DungeonCrawlerEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DungeonCrawlerEditor-Linux-DebugGame.commands = $$build DungeonCrawlerEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DungeonCrawlerEditor-Linux-Shipping.commands = $$build DungeonCrawlerEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DungeonCrawlerEditor-Linux-Test.commands = $$build DungeonCrawlerEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DungeonCrawlerEditor.commands = $$build DungeonCrawlerEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	DungeonCrawler-Linux-Debug \
	DungeonCrawler-Linux-DebugGame \
	DungeonCrawler-Linux-Shipping \
	DungeonCrawler-Linux-Test \
	DungeonCrawler \
	DungeonCrawlerEditor-Linux-Debug \
	DungeonCrawlerEditor-Linux-DebugGame \
	DungeonCrawlerEditor-Linux-Shipping \
	DungeonCrawlerEditor-Linux-Test \
	DungeonCrawlerEditor \
