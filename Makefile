...
DungeonCrawler-Linux-Debug:
	 $(PROJECTBUILD) DungeonCrawler Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawler-Linux-DebugGame:
	 $(PROJECTBUILD) DungeonCrawler Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawler-Linux-Shipping:
	 $(PROJECTBUILD) DungeonCrawler Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawler-Linux-Test:
	 $(PROJECTBUILD) DungeonCrawler Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawler:
	 $(PROJECTBUILD) DungeonCrawler Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawlerEditor-Linux-Debug:
	 $(PROJECTBUILD) DungeonCrawlerEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawlerEditor-Linux-DebugGame:
	 $(PROJECTBUILD) DungeonCrawlerEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawlerEditor-Linux-Shipping:
	 $(PROJECTBUILD) DungeonCrawlerEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawlerEditor-Linux-Test:
	 $(PROJECTBUILD) DungeonCrawlerEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DungeonCrawlerEditor:
	 $(PROJECTBUILD) DungeonCrawlerEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
